...
public class WormholeButton extends AbstractButtonWidget {
    ...
    public void render(int mouseX, int mouseY, float partialTicks){
        ...
        ScreenUtils.drawCenteredString(Minecraft.getMinecraft().fontRenderer, new TextComponentTranslation(this.textKey), this.x + this.width / 2f, this.y + this.height / 2f - 4, this.active ? 0xFFFFFFFF : Integer.MAX_VALUE);
    }
    ...
    protected ITextComponent getNarrationMessage(){
        return new TextComponentTranslation(this.textKey);
    }
}
