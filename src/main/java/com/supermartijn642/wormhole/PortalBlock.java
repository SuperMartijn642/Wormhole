...
public class PortalBlock extends PortalGroupBlock {
    ...
    public PortalBlock(){
        super(Properties.create(Material.PORTAL).doesNotBlockMovement().hardnessAndResistance(-1.0F).sound(SoundType.GLASS).setLightLevel(o -> 11).noDrops(), "portal", PortalTile::new);
