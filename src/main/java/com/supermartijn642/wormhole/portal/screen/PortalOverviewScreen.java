...
public class PortalOverviewScreen extends PortalGroupScreen {
    ...
    protected void render(MatrixStack matrixStack, int mouseX, int mouseY){
        ...
        this.font.func_238407_a_(matrixStack, new TranslationTextComponent("wormhole.portal.gui.status"), 190, 49, 4210752);
        this.drawStringRightAligned(matrixStack, status.getStatus(), 312, 49);
        this.font.func_238407_a_(matrixStack, new TranslationTextComponent("wormhole.portal.gui.idle_cost"), 190, 61, 4210752);
        ...
        this.font.func_238407_a_(matrixStack, new TranslationTextComponent("wormhole.portal.gui.teleport_cost"), 190, 73, 4210752);
    ...
    private void drawStringRightAligned(MatrixStack matrixStack, ITextComponent textComponent, int x, int y){
        int width = this.font.func_238414_a_(textComponent);
        this.font.func_238407_a_(matrixStack, textComponent, x - width, y, 4210752);
    }
