...
public class PortalOverviewScreen extends PortalGroupScreen {
    ...
    private void renderInfo(MatrixStack poseStack, int storedEnergy, int idleCost, int teleportCost, PortalTarget target){
        ...
        if(target != null){
            ...
            // dimension
            Block block = null;
            if(target.dimension.equals(World.OVERWORLD))
                block = Blocks.GRASS_PATH;
            else if(target.dimension.equals(World.NETHER))
                block = Blocks.NETHERRACK;
            else if(target.dimension.equals(World.END))
    ...
    @Override
    protected void renderForeground(MatrixStack poseStack, int mouseX, int mouseY, PortalGroup group){
    ...
    @Override
    protected void renderTooltips(MatrixStack poseStack, int mouseX, int mouseY, PortalGroup group){
        // status
