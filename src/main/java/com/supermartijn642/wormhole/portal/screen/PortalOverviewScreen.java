...
public class PortalOverviewScreen extends PortalGroupScreen {
    ...
    protected void render(MatrixStack matrixStack, int mouseX, int mouseY){
        ...
        ScreenUtils.drawString(matrixStack, this.font, new TranslationTextComponent("wormhole.portal.gui.status"), 190, 49, 4210752);
        this.drawStringRightAligned(matrixStack, status.getStatus(), 312, 49);
        ScreenUtils.drawString(matrixStack, this.font, new TranslationTextComponent("wormhole.portal.gui.idle_cost"), 190, 61, 4210752);
        ...
        ScreenUtils.drawString(matrixStack, this.font, new TranslationTextComponent("wormhole.portal.gui.teleport_cost"), 190, 73, 4210752);
    ...
    private void drawStringRightAligned(MatrixStack matrixStack, ITextComponent textComponent, int x, int y){
        ...
        ScreenUtils.drawString(matrixStack, this.font, textComponent, x - width, y, 4210752);
    }
