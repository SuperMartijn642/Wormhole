...
public class PortalGroup {
    ...
    public PortalGroup(World level, NBTTagCompound tag){
        this.level = level;
    ...
    public void setTarget(int index, PortalTarget target){
        ...
        for(BlockPos pos : this.shape.targetCells){
            TileEntity entity = this.level.getTileEntity(pos);
    ...
    public void destroy(){
        this.deactivate();
        PortalGroupCapability groups = this.level.getCapability(PortalGroupCapability.CAPABILITY, null);
        if(groups != null)
            groups.remove(this);
    }
