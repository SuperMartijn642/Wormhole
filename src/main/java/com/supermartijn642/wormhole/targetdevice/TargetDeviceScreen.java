...
import com.supermartijn642.wormhole.screen.*;
...
public class TargetDeviceScreen extends WormholeScreen {
    ...
    private WormholeTextField currentTextField;
    ...
    private void addTargetWidgets(){
        ...
        this.facingLabels.add(this.addWidget(new TargetLabel(this::getOrDefault, index, 187, y, 50, 10, "wormhole.target_device.gui.facing", target -> "wormhole.direction." + EnumFacing.fromAngle(target.yaw).toString(), true)));
        // remove button
    ...
    protected void addWidgets(){
        ...
        // current location
        this.currentTextField = this.addWidget(new WormholeTextField(8, 0, 59, 10, I18n.format("wormhole.target_device.gui.target_name"), PortalTarget.MAX_NAME_LENGTH) {
            @Override
        ...
        this.currentFacingLabel = this.addWidget(new CurrentTargetLabel(187, 0, 50, 10, "wormhole.gui.label", "wormhole.target_device.gui.facing", "wormhole.direction." + EnumFacing.fromAngle(this.targetYaw), true));
    ...
    protected void render(int mouseX, int mouseY){
        ...
        GlStateManager.translate(0, height + 1, 0);
