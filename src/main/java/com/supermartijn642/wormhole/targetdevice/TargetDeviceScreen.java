...
public class TargetDeviceScreen extends BaseScreen {
    ...
    public TargetDeviceScreen(EntityPlayer player, EnumHand hand, BlockPos pos, float yaw){
        super(new TextComponentTranslation("wormhole.target_device.gui.title"));
        this.player = player;
        this.hand = hand;
        this.currentPos = pos;
        this.currentYaw = yaw;
    ...
    protected void render(int mouseX, int mouseY){
        ...
        if(this.selectedTarget >= 0){
            ...
            DimensionType type = this.player.world.provider.getDimensionType();
            ...
            this.renderTargetInfo(this.currentTargetNameField.getText().trim(), this.currentPos, type.getId(), dimensionName, this.currentYaw);
        }
    ...
    private void renderTargetInfo(String name, BlockPos pos, int dimension, String dimensionName, float yaw){
        ...
        ScreenUtils.drawString(this.font, I18n.format("wormhole.direction." + EnumFacing.fromAngle(yaw).toString()), 132, 72, Integer.MAX_VALUE);
    }
