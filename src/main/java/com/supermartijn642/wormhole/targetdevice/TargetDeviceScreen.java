...
public class TargetDeviceScreen extends ItemBaseWidget {
    ...
    public TargetDeviceScreen(EnumHand hand, BlockPos pos, float yaw){
    ...
    private void renderTargetInfo(String name, BlockPos pos, DimensionType dimension, ITextComponent dimensionName, float yaw){
        ...
        ScreenUtils.drawString(TextComponents.translation("wormhole.direction." + EnumFacing.fromAngle(yaw)).get(), 132, 72, Integer.MAX_VALUE);
    }
