    ...
    public void renderButton(MatrixStack matrixStack, int mouseX, int mouseY, float partialTicks){
        if(this.visible){
            ...
            if(!s.isEmpty()){
                ...
                j1 = font.func_238407_a_(matrixStack, new StringTextComponent(s1), (float)l, (float)i1, i2);
            }
            ...
            if(!s.isEmpty() && flag && j < s.length()){
                font.func_238407_a_(matrixStack, new StringTextComponent(s.substring(j)), (float)j1, (float)i1, i2);
            }
