...
public class CoalGeneratorBlock extends WormholeBlock {
    ...
    public void addInformation(ItemStack stack, IBlockReader worldIn, List<ITextComponent> tooltip, ITooltipFlag flagIn){
        ...
        tooltip.add(new TranslationTextComponent("wormhole.coal_generator.info", range, EnergyFormat.formatEnergyPerTick(WormholeConfig.INSTANCE.coalGeneratorPower.get())).mergeStyle(TextFormatting.AQUA));
        ...
        tooltip.add(new StringTextComponent(EnergyFormat.formatCapacity(energy, WormholeConfig.INSTANCE.coalGeneratorCapacity.get())).mergeStyle(TextFormatting.YELLOW));
    }
